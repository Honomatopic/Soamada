$("#don_adresse").autocomplete({
    source: function (request, response) {
        $.ajax({
            url: "https://api-adresse.data.gouv.fr/search/?label=" + $("input[name='don_adresse']").val(),
            data: { q: request.term },
            dataType: "json",
    ...
    select: function(event, ui) {
        $('#don_cp').val(ui.item.postcode);
        $('#don_ville').val(ui.item.city);
    }
});
...
$("#don_cp").autocomplete({
    source: function (request, response) {
        $.ajax({
            url: "https://api-adresse.data.gouv.fr/search/?postcode=" + $("input[name='don_cp']").val(),
            data: { q: request.term },
            dataType: "json",
            success: function (data) {
                var postcodes = [];
